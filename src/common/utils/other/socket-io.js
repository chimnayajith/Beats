...
if (client.shard.ids.includes(0)) {
  socket.on("spotify-confirmation", (data) => {
    const embed = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription(
        `Your spotify account has been authorized. The account linked to <:beats:1115516004886388736> Beats is : **[${data.spotifyUserId}](https://open.spotify.com/user/${data.spotifyUserId})**.\n\nUse the command </spotify play:1125445351562809364> to access your playlists and add them to the queue effortlessly.`,
      )
