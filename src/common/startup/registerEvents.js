...
module.exports = async () => {
  ...
  const processEvents = readdirSync("./src/events/process").filter((file) =>
    file.endsWith(".js"),
  );
  ...
  const clientEvents = readdirSync("./src/events/client").filter((file) =>
    file.endsWith(".js"),
  );
  ...
  const clientRestEvents = readdirSync("./src/events/client_rest").filter(
