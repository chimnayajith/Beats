...
const beats_bot = mongoose.createConnection(process.env.DATABASE_BEATS_BOT_URI);
...
const beats_web = mongoose.createConnection(process.env.DATABASE_BEATS_WEB_URI);
