...
module.exports = async (queue) => {
    const enotconn = new EmbedBuilder().setColor("#2f3136").setDescription("Due to an error in the queue, it has been deleted.This is to prevent the bot from crashing.")
