...
module.exports = async (queue , error) => {
    ...
    const embed = new EmbedBuilder().setColor("#2f3136").setDescription(`\`\`\`${error.stack.slice(0,4000)}\`\`\``).setTitle(`Connection Error at **${queue.guild.name}⠀|⠀${error.message.substring(0,200)}**`)
