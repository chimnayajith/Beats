...
module.exports = async (client, guild) => {
  await stats.updateOne({ _id: "guilds" }, { $pull: { guild_ids: guild.id } });
  ...
  const webhookClient = new WebhookClient({
    url: "https://discord.com/api/webhooks/1118508137331306507/0TZe3roWpzv0DgMNC4h5AU1fARJ_eSFfqFMohWhMInSs6jL7is51xq1MJTJx1uiHz7ua",
  });
