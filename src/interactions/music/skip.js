...
module.exports = {
  ...
  async execute(client, interaction) {
    ...
    const no_music = new EmbedBuilder()
      .setColor("#2f3136")
    ...
    const skipped = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription(
        `**<:right:905743975607046145> ⠀|⠀ Current song skipped!**`,
      );
    ...
    if (!queue || !queue.isPlaying())
      return interaction.reply({ embeds: [no_music], ephemeral: true });
    const disconnected = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription(
        `<a:tick:889018326255288360>⠀ | ⠀Queue Empty. Beats has been \`disconnected\`.`,
      );
