...
module.exports = {
  ...
  async execute(client, interaction) {
    ...
    const noSongs = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription(
        `**<a:warn:889018313143894046> ⠀|⠀ Minimum 3 songs to be queued to shuffle!**`,
      );
    const shuffleSuccess = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription(
        `**<a:shuffle:903278425702269040> ⠀|⠀ Queue shuffled : ${queue.tracks.size} songs**`,
      );
    ...
    if (!(queue.tracks.toArray().length >= 3))
      return interaction.reply({ embeds: [noSongs], ephemeral: true });
