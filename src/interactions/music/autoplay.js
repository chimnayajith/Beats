...
module.exports = {
  ...
  async execute(client, interaction) {
    ...
    const autoplayEnabled = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription("<a:onoff:889018175721717781>⠀|⠀Autoplay **enabled**");
    const autoplayDisabled = new EmbedBuilder()
      .setColor("#2f3136")
      .setDescription("<a:onoff:889018175721717781>⠀|⠀Autoplay **disabled**");
