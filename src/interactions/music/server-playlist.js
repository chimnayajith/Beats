...
const { logIdRequired, logIfRequired } = require("../../common/utils/scripts/settingsUtil");
...
module.exports = {
  ...
  async execute(client, interaction) {
    ...
    if(interaction.options.getSubcommand() === "setup"){
        ...
        await logIfRequired(interaction.guild.id ,interaction.guild.ownerId, "playlistUpdateLogs playlistSetup" , {
        ...
        await logIfRequired(interaction.guild.id ,interaction.guild.ownerId, "playlistUpdateLogs playlistAdd" , {
          guildName: interaction.guild.name,
          guildID: interaction.guild.id,
          guildIcon: interaction.guild.iconURL(),
