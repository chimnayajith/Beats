...
const {
  ...
  djRemoveRole,
  logIfRequired
} = require("../../utils/scripts/settingsUtil");
module.exports = {
    ...
    if (!data.doesExist) {
      ...
      collector.on("collect", async (collected) => {
        ...
        if (value === "confirm") {
          ...
          await logIfRequired(interaction.guild.id , "djSettingsUpdateLogs addRole" , {
      ...
      if (!data.isRoleInArray) {
        ...
        collector.on("collect", async (collected) => {
          ...
          if (value === "confirm") {
            ...
            await logIfRequired(interaction.guild.id , "djSettingsUpdateLogs removeRole" , {
              guildName : interaction.guild.name,
              guildIcon : interaction.guild.iconURL(),
              guildID : interaction.guild.id,
              djRole : role.id,
